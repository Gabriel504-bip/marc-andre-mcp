...
export const qboInventaireAjuster: ToolDefinition = {
  name: 'ma_qbo_inventaire_ajuster',
  tier: 2,
  description:
    "Ajuste la QUANTITÉ EN MAIN d'un ou plusieurs articles d'inventaire dans QuickBooks (transaction " +
  ...
  inputSchema: z.object({
    ...
    date: z
      ...
      .regex(/^\d{4}-\d{2}-\d{2}$/)
      .describe(
        "Date de la transaction d'ajustement (AAAA-MM-JJ). Pour corriger un solde de clôture, mets la " +
    ...
    compteAjustement: z
      ...
      .min(1)
      .describe(
        "Compte de contrepartie : nom exact ou Id QuickBooks du compte où l'écart est imputé " +
    ...
    ajustements: z
      .array(
        z.object({
          ...
          nouvelleQuantite: quantiteTolerante
            .optional()
            .describe(
              'Quantité VISÉE après ajustement. Préférable : QuickBooks calcule lui-même l\'écart au ' +
          ...
          variationQuantite: quantiteTolerante
            .optional()
            .describe(
              "Variation à appliquer (+ ou −), alternative à nouvelleQuantite. Fournir l'un OU l'autre, " +
      ...
      .max(50)
      .describe(
        "Articles à ajuster (50 maximum par transaction). Les articles dont la quantité visée égale " +
    ...
    confirmation: confirmationTolerante
      .default(false)
      .describe(
        "FAUX (défaut) = aperçu : quantités actuelles, cibles, écarts, impact estimé et " +
    ...
    jetonApprobation: z
      ...
      .optional()
      .describe(
        "Jeton retourné par l'aperçu, obligatoire pour écrire. Lié au contenu EXACT et valable " +
