...
const ecritureManuelleCreerInput = z.object({
  ...
  ecritures: z
    ...
    .max(25)
    .describe(
      "1 à 25 écritures de journal indépendantes par appel (budget de la fonction serveur — " +
...
export const ecritureManuelleCreer: ToolDefinition = {
  ...
  tier: 2,
  description:
    "Crée une ou plusieurs écritures de journal manuelles libres (ex. régularisation DAS " +
