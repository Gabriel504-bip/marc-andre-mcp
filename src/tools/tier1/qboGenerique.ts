 ...
 */
export const qboLire: ToolDefinition = {
  name: 'ma_qbo_lire',
  tier: 1,
  description:
    "Lecture LIBRE de QuickBooks : exécute n'importe quelle requête SELECT, ou lit une entité par son " +
  ...
  inputSchema: z.object({
    ...
    requete: z
      ...
      .optional()
      .describe(
        "Requête QuickBooks (langage SQL-like d'Intuit). Doit commencer par SELECT. MAXRESULTS 1000 " +
