...
export const chercherClient: ToolDefinition = {
  name: 'ma_chercher_client',
  tier: 1,
  description:
    "Recherche un client par nom, courriel ou compagnie (tolère accents/ponctuation partiels). " +
...
export const listerClients: ToolDefinition = {
  name: 'ma_lister_clients',
  tier: 1,
  description:
    'Liste les dossiers clients, paginée. Ne renvoie PAS les threads/onboarding complets ' +
...
export const ficheClient: ToolDefinition = {
  name: 'ma_fiche_client',
  tier: 1,
  description:
    "Fiche complète d'un client. `sections` est OBLIGATOIRE à préciser (identite, quickbooks, " +
