...
export const financeCabinet: ToolDefinition = {
  name: 'ma_finance',
  tier: 1,
  requiresAdmin: true,
  description:
    "Tableau de bord financier du cabinet (ARR, deals HubSpot, abonnements). ⚠️ L'ARR est calculé " +
...
export const tachesEquipe: ToolDefinition = {
  ...
  requiresAdmin: true,
  description:
    "Tâches Asana de toute l'équipe (en retard, cette semaine, semaine prochaine) par employé. " +
...
export const journalAudit: ToolDefinition = {
  ...
  requiresAdmin: true,
  description:
    "Journal d'audit d'un mois donné — y compris les actions posées par cet agent lui-même " +
...
export const accueilSynthese: ToolDefinition = {
  name: 'ma_accueil_synthese',
  tier: 1,
  description:
    "Tuiles de synthèse du cabinet (clients par statut, écritures en attente, tâches en retard, " +
