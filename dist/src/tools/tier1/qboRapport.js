 ...
 */
export const qboRapport = {
    name: 'ma_qbo_rapport',
    tier: 1,
    description: "Sort n'importe quel RAPPORT QuickBooks d'un dossier : état des résultats (ProfitAndLoss), bilan " +
    ...
    inputSchema: z.object({
        ...
        rapport: z
            .string()
            .min(1)
            .describe("Nom du rapport QuickBooks. Ex. « ProfitAndLoss » (état des résultats), « BalanceSheet » " +
        ...
        parametres: z
            ...
            .optional()
            .describe('Paramètres QuickBooks, transmis tels quels. Les plus utiles : start_date et end_date ' +
        ...
        detail: z
            ...
            .default(false)
            .optional()
            .describe('FAUX (défaut) = rapport aplati et lisible, plafonné à 200 lignes — suffisant pour analyser ' +
