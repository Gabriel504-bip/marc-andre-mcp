...
/** §3.1 outils 6-7. */
export const qboStatut = {
    name: 'ma_qbo_statut',
    tier: 1,
    description: 'Statut de connexion QuickBooks (connecté, compagnie, environnement). Ne renvoie jamais de ' +
...
export const qboListesReference = {
    name: 'ma_qbo_listes_reference',
    tier: 1,
    description: "Listes de référence QuickBooks d'un client (comptes, clients/fournisseurs, codes de taxe, " +
