...
const criteres = z
    ...
    source: z
        .string()
        .optional()
        .describe("Source du job (ex. « conciliation-exercice-ecritures », « ecriture-manuelle-agent »). " +
        'Omettre pour balayer toutes les sources.'),
})
    .optional()
    .describe('Filtres de sélection. Sans critères, TOUTES les lignes actionnables des jobs prêts pour révision ' +
...
export const ecrituresModifierLot = {
    name: 'ma_ecritures_modifier_lot',
    tier: 2,
    description: 'Modifie EN LOT les écritures en attente du module Écritures — typiquement pour reclasser un compte ' +
    ...
    inputSchema: z.object({
        ...
        modifications: z
            ...
            .describe('Champs à écrire, ex. { compteCredit: "Services" }. Champs permis : date, description, ' +
...
export const ecrituresPublierLot = {
    name: 'ma_ecritures_publier_lot',
    tier: 2,
    description: 'Publie EN LOT dans QuickBooks les écritures en attente du module Écritures, quelle que soit leur ' +
    ...
    inputSchema: z.object({
        ...
        confirmation: confirmationTolerante
            .default(false)
            .describe("FAUX (défaut) = aperçu de ce qui SERAIT publié, rien n'est touché dans QuickBooks. VRAI publie " +
