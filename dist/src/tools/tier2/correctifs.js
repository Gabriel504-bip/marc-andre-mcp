...
const correctifsAnalyserInput = z.object({
    ...
    csvText: z
        .string()
        .min(1)
        .describe('Contenu TEXTUEL du CSV de correctifs (en-tête + lignes), pas un chemin ni du base64. ' +
...
const correctifsAppliquerInput = z.object({
    ...
    simulation: simulationTolerante
        .default(true)
        .describe('VRAI (défaut) = simulation, rien n\'est touché dans QuickBooks. Mettre FAUX exécute ' +
    ...
    noLignes: z
        ...
        .optional()
        .describe('Numéros de ligne du CSV à traiter, pour essayer UNE seule ligne avant de lâcher le lot ' +
...
export const correctifsAnalyser = {
    name: 'ma_correctifs_analyser',
    tier: 2,
    description: "Analyse un CSV de correctifs (supprimer / reclasser) : apparie chaque ligne à l'objet " +
...
export const correctifsAppliquer = {
    name: 'ma_correctifs_appliquer',
    tier: 2,
    description: 'Applique le plan de correctifs bâti par ma_correctifs_analyser. ⚠️ SIMULATION PAR DÉFAUT : ' +
