...
export const qboEcrire = {
    ...
    inputSchema: z.object({
        ...
        donnees: z
            ...
            .describe("Objet QuickBooks à envoyer, tel que documenté par Intuit. Pour « modifier »/« supprimer », " +
            'inclure Id (le SyncToken est relu automatiquement, inutile de le fournir).'),
        sparse: z
            .boolean()
            .default(false)
            .optional()
            .describe('Mise à jour partielle : seuls les champs fournis sont modifiés. FAUX (défaut) remplace ' +
