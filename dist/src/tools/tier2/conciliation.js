import { exerciceInputSchema, summarizeConciliation, TIMEOUT_CONCILIATION_LENTE_MS, } from '../tier1/conciliation.js';
/**
 ...
 */
export const conciliationExerciceVersEcritures = {
    name: 'ma_conciliation_exercice_vers_ecritures',
    tier: 2,
    description: 'Envoie RÉELLEMENT dans le module Écritures les mouvements à comptabiliser et les ' +
