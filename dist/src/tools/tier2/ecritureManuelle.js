...
const ecritureManuelleCreerInput = z.object({
    ...
    reference: z
        .string()
        .min(1)
        .describe("Identifiant unique fourni par l'appelant (ex. « das-federal-2026-07-entrenous »). " +
    ...
    csvText: z
        .string()
        .min(1)
        .describe('Contenu TEXTUEL du CSV de l\'écriture (en-tête + lignes), pas un chemin ni du base64. ' +
...
export const ecritureManuelleCreer = {
    ...
    tier: 2,
    description: "Crée une écriture de journal manuelle libre (ex. régularisation DAS fédérale) à partir " +
